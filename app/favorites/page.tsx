...
interface Listing {
  ...
  link: string;
    ...
    // İkinci El Listings (IDs 1–8)
   {
    ...
    metro: "",
    time: "",
    stats: ["2+1", "117 m²", "1. Kat"],
    footer: "Etimesgut/Ankara",
    image: "/KORU KONFOR 5+1.png",
    imageAlt: "/koru-map.png",
  },
  {
    id: "2",
    title: "Natura İncek 2+1",
    link: "/natura-20",
    type: "standard",
    price: "7.75 Milyon",
    label: "İkinci El",
    metro: "",
    time: "",
    stats: ["2+1 Flat", "80 m²", "1. Bodrum Kat"],
