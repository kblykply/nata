...
export default function ProjectHeroCloudSection() {
  const tHero = useTranslations("tempoint.hero");
  ...
  return (
    <section className="relative w-full h-[112svh] md:h-[120svh] overflow-hidden bg-gradient-to-b from-[#006d9d] to-[#e6f3fd]">
      ...
      {/* Building image */}
      <div className="absolute -bottom-32 md:-bottom-48 left-0 w-full h-full z-20 pointer-events-none">
        <Image
          src="/new-buildings/tempoint.png"
          alt="Building"
          fill
      ...
      {/* Content goes here */}
      <div className="flex justify-center my-5 relative z-30">
