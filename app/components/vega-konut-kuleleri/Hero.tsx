...
export default function ProjectHeroCloudSection() {
  const tHero = useTranslations("vegaKonutKuleleri.hero");

  return (
    <section className="relative w-full h-[128svh] md:h-[140svh] overflow-hidden bg-gradient-to-b from-[#006d9d] to-[#e6f3fd]">
      ...
      {/* Building image */}
      <div className="absolute bottom-20 md:bottom-12 left-0 w-full h-full z-20 pointer-events-none">
        <Image
