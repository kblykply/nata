...
export default function DesignSection() {
  ...
  const gallery = [
    "/proje-galeri/vegakonut-1.jpeg",
    "/proje-galeri/vegakonut-2.jpeg",
    "/proje-galeri/vegakonut-3.jpeg",
    "/proje-galeri/vegakonut-4.jpeg",
        "/proje-galeri/vegakonut-5.jpeg",
      ...
      <div className="max-w-screen-xl mx-auto w-full flex flex-col lg:flex-row items-center justify-between gap-10 relative z-10">
        ...
        <div className="w-full max-w-xl z-25">
          <h2 className="text-3xl sm:text-4xl font-semibold text-gray-900 leading-tight">
            Nata Vega Konut Kuleleri
          </h2>
          <p className="mt-6 text-sm text-gray-700 leading-relaxed">
            Şehrin merkezinde yükselen Nata Vega, ayrıcalıklı bir yaşam alanı sunuyor.
          </p>
          <button
            onClick={() => {
              setGalleryIndex(0);
        ...
        <div className="relative w-full lg:w-1/2 h-[300px] sm:h-[400px] lg:h-[600px]">
          <Image
            src="/proje-galeri/natavegakonutimage.jpg"
            alt="Design"
            fill
