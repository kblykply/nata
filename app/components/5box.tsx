...
export default function InfoSection() {
  return (
    <section className="grid grid-cols-2 md:grid-cols-5 gap-4 max-w-screen-xl mx-auto py-10 px-4">
      ...
      {/* Box 1 */}
      <div className="relative rounded-lg p-4 h-78 bg-[#c33a39] text-white overflow-hidden flex flex-col justify-between">
        ...
        <img src="/kutular/kutu-1.png" alt="Plan" className="absolute bottom-0 right-0 w-40 object-contain" />
      </div>

      {/* Box 2 */}
      <div className="relative rounded-lg p-4 h-78 bg-[#f5f5f5] text-black overflow-hidden flex flex-col justify-between">
        <p className="text-sm font-semibold leading-snug max-w-[80%]">
          İşletmeler için en kaliteli <span className="text-red-500 font-semibold">OFISLER</span>
        </p>
        <img src="/kutular/kutu-2.png" alt="Building" className="absolute bottom-0 right-0 w-20 object-contain" />
      </div>

      {/* Box 3 */}
      <div className="relative rounded-lg p-4 h-78 bg-[#e0e0e0] text-black overflow-hidden flex flex-col justify-between">
        ...
        <img src="/kutular/kutu-3.png" alt="Phone" className="absolute bottom-0 right-0 w-30 object-contain" />
      </div>
      ...
      <div
        ...
        style={{ backgroundImage: "url(/kutular/kutu-4.png)" }}
      >
      ...
      {/* Box 5 */}
      <div className="relative rounded-lg p-4 h-78 bg-[#fafafa] text-black overflow-hidden flex flex-col justify-between">
        <p className="text-sm leading-snug max-w-[80%] font-semibold">
          Herhangi bir soruda <span className="text-red-500 font-semibold">5 dakika</span> içinde cevap
        </p>
        <img src="/kutular/kutu-5.png" alt="Person" className="absolute bottom-2 right-2 w-35 object-contain" />
      </div>
