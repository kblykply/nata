...
import {
  ...
  export default function Magazine() {
    const pages = Array.from({ length: totalPages }, (_, i) => `/n-bulten-bir/page-${i}.jpg`);
...
>
                ...
                <div className="fixed bottom-6 left-1/2 -translate-x-1/2 bg-white/90 backdrop-blur-md rounded-full shadow-lg px-6 py-3 flex items-center gap-4 text-gray-700 z-[1000] border border-gray-200">
                  <button onClick={goPrev} className="hover:text-blue-600 transition" title="Previous Page">
                    <FaArrowLeft size={20} />
                  </button>
                  <button onClick={goNext} className="hover:text-blue-600 transition" title="Next Page">
                  ...
                  <button onClick={goFullscreen} className="hover:text-indigo-600 transition" title="Full Screen">
                    <FaExpand size={20} />
                  </button>
